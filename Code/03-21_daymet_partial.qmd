...
field
```
explanatory variable/ predicted variable "strength_gtex" gives cotton fibre quality
# Study description  
...
```{r}
states <- us_states() %>% 
  filter(!(state_abbr %in% c("PR", "AK", "HI"))) ## the exclamation point is used to negate the filter function, it keeps data which is not part of the filter function. 
