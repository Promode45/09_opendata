...
fe_month_sum <- fe_month %>% 
  group_by(year,site,month,
           month_abb, strength_gtex) %>% ## added month_abb and strength, so that it is not dropped in the output dataframe. 
